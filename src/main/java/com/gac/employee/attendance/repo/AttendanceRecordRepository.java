...
public interface AttendanceRecordRepository extends JpaRepository<AttendanceRecordModel,Integer> {
    List<AttendanceRecordModel> findByRecordTimeAfterAndRecordTimeBeforeAndVerifyState(String recordTime, String recordTime2, AttendanceState verifyState);
    List<AttendanceRecordModel> findByRecordTimeGreaterThanEqual(String lastMonth);
